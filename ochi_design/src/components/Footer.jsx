...
const Footer = () => {
  return (
    <div className="w-full h-screen bg-zinc-900 px-20 py-20 flex gap-10">

      {/* LEFT */}
      <div className='w-1/2 h-full flex flex-col justify-between font-["Founders_Grotesk_Condensed"]'>
        <div>
          <h1 className="text-[7vw] leading-none tracking-tighter">EYE-</h1>
          <h1 className="text-[7vw] leading-none tracking-tighter -mt-6">
            OPENING
          </h1>
        </div>
      ...
      <div className="w-1/2 h-full flex flex-col justify-between">
        ...
        <h1 className='text-[6vw] leading-none tracking-tighter font-["Founders_Grotesk_Condensed"] uppercase'>
          Presentations
        </h1>

        <div className='font-["Neue_Montreal"] space-y-2'>
          <a className="block text-sm font-light hover:underline" href="#">
            Facebook
          </a>
          <a className="block text-sm font-light hover:underline" href="#">
            Instagram
